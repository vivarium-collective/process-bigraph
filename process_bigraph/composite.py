...
# Step-scheduling graph extracted to scheduling.py; re-imported here so
# `process_bigraph.composite.<fn>` (and the package top-level re-exports)
# keep resolving for external callers and internal Composite use.
from process_bigraph.scheduling import (  # noqa: F401
    assert_interface,
    find_step_triggers,
    wire_step_layers,
    explode_path,
